...
import * as dependency_2 from 'react-dom/server';
import * as dependency_3 from '@beyond-js/widgets/controller';

const {Bundle: __Bundle} = dependency_0;
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/react-widgets@18.21.1/base"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./controller', {hash: 1686610974, creator: function (require, exports) {
"use strict";
...
/*bundle*/class ReactWidgetController extends _controller.WidgetServerController {
  render(props) {
    if (!this.Widget) {
      return {
...
ims.set('./styles', {hash: 3655782595, creator: function (require, exports) {
"use strict";
...
ims.set('./widget', {hash: 2923914692, creator: function (require, exports) {
"use strict";
