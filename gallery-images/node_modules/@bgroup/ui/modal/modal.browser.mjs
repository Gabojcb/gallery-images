...
import * as dependency_2 from '@bgroup/ui/form';
import * as dependency_3 from '@bgroup/ui/icons';
import * as dependency_4 from 'react-dom';

const {Bundle: __Bundle} = dependency_0;
const __pkg = new __Bundle({"module":{"vspecifier":"@bgroup/ui@0.0.34/modal"},"type":"code","name":"modal"}, import.meta.url).package();;
...
ims.set('./alert', {hash: 2870887663, creator: function (require, exports) {
"use strict";
...
/*bundle*/function BeyondAlertModal(props) {
...
ims.set('./children', {hash: 1553763792, creator: function (require, exports) {
"use strict";
...
ims.set('./confirm', {hash: 2995532002, creator: function (require, exports) {
"use strict";
...
var _form = require("@bgroup/ui/form");
var _modal = require("./modal");
/*bundle*/const BeyondConfirmModal = properties => {
...
ims.set('./modal', {hash: 3324356653, creator: function (require, exports) {
"use strict";
...
/*bundle*/function BeyondModal(props) {
...
__pkg.exports.descriptor = [{"im":"./alert","from":"BeyondAlertModal","name":"BeyondAlertModal"},{"im":"./confirm","from":"BeyondConfirmModal","name":"BeyondConfirmModal"},{"im":"./modal","from":"BeyondModal","name":"BeyondModal"}];

export let BeyondAlertModal, BeyondConfirmModal, BeyondModal;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'BeyondAlertModal') && (BeyondAlertModal = require ? require('./alert').BeyondAlertModal : value);
    (require || prop === 'BeyondConfirmModal') && (BeyondConfirmModal = require ? require('./confirm').BeyondConfirmModal : value);
    (require || prop === 'BeyondModal') && (BeyondModal = require ? require('./modal').BeyondModal : value);
