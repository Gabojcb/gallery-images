...
import * as dependency_3 from '@beyond-js/react-widgets/page';
import * as dependency_4 from 'react';

const {Bundle: __Bundle} = dependency_1;
const __pkg = new __Bundle({"module":{"vspecifier":"@bgroup/ui@0.0.34/coming-soon"},"type":"widget"}, import.meta.url).package();;
...
brequire('@beyond-js/widgets/render').widgets.register([{"name":"coming-soon","vspecifier":"@bgroup/ui@0.0.34/coming-soon","is":"page","route":"/components/coming-soon"}]);

brequire('@beyond-js/kernel/styles').styles.register('@bgroup/ui@0.0.34/coming-soon')
...
ims.set('./controller', {hash: 3327242745, creator: function (require, exports) {
"use strict";
...
ims.set('./views/index', {hash: 719686821, creator: function (require, exports) {
"use strict";
...
//# sourceMappingURL=coming-soon.browser.mjs.map