System.register(["@beyond-js/kernel/bundle", "react", "@beyond-js/kernel/routing", "@bgroup/ui/icons", "@bgroup/ui/spinner", "@beyond-js/kernel/styles"], function (_export, _context) {
  "use strict";

  var dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, __Bundle, __pkg, ims, BeyondButton, BeyondCheckbox, BeyondForm, BeyondInput, BeyondRadio, BeyondSwitch, BeyondTextarea, __beyond_pkg, hmr;
  _export({
    BeyondButton: void 0,
  ...
  return {
    setters: [function (_beyondJsKernelBundle) {
      ...
      dependency_3 = _bgroupUiIcons;
    }, function (_bgroupUiSpinner) {
      dependency_4 = _bgroupUiSpinner;
    ...
    execute: function () {
      ...
      **************************/
      ...
      __pkg.exports.process = function ({
        ...
        (require || prop === 'BeyondForm') && _export("BeyondForm", BeyondForm = require ? require('./form').BeyondForm : value);
        (require || prop === 'BeyondInput') && _export("BeyondInput", BeyondInput = require ? require('./input').BeyondInput : value);
        (require || prop === 'BeyondRadio') && _export("BeyondRadio", BeyondRadio = require ? require('./radio').BeyondRadio : value);
...
//# sourceMappingURL=form.sjs.js.map