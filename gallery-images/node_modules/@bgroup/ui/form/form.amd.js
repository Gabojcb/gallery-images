define(["exports", "module", "@beyond-js/kernel/bundle", "react", "@beyond-js/kernel/routing", "@bgroup/ui/icons", "@bgroup/ui/spinner", "@beyond-js/kernel/styles"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.hmr = _exports.__beyond_pkg = _exports.BeyondTextarea = _exports.BeyondSwitch = _exports.BeyondRadio = _exports.BeyondInput = _exports.BeyondForm = _exports.BeyondCheckbox = _exports.BeyondButton = void 0;
  const {
    Bundle: __Bundle
  } = dependency_0;
  ...
  **************************/
  ...
  let BeyondButton, BeyondCheckbox, BeyondForm, BeyondInput, BeyondRadio, BeyondSwitch, BeyondTextarea;
  ...
  __pkg.exports.process = function ({
    ...
    (require || prop === 'BeyondButton') && (_exports.BeyondButton = BeyondButton = require ? require('./button').BeyondButton : value);
    (require || prop === 'BeyondCheckbox') && (_exports.BeyondCheckbox = BeyondCheckbox = require ? require('./checkbox').BeyondCheckbox : value);
    (require || prop === 'BeyondForm') && (_exports.BeyondForm = BeyondForm = require ? require('./form').BeyondForm : value);
    (require || prop === 'BeyondInput') && (_exports.BeyondInput = BeyondInput = require ? require('./input').BeyondInput : value);
    (require || prop === 'BeyondRadio') && (_exports.BeyondRadio = BeyondRadio = require ? require('./radio').BeyondRadio : value);
    (require || prop === 'BeyondSwitch') && (_exports.BeyondSwitch = BeyondSwitch = require ? require('./switch').BeyondSwitch : value);
    (require || prop === 'BeyondTextarea') && (_exports.BeyondTextarea = BeyondTextarea = require ? require('./textarea').BeyondTextarea : value);
  };
...
//# sourceMappingURL=form.amd.js.map