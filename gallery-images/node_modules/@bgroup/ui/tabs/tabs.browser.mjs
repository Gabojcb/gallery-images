...
const __pkg = new __Bundle({"module":{"vspecifier":"@bgroup/ui@0.0.34/tabs"},"type":"code","name":"tabs"}, import.meta.url).package();;
...
ims.set('./beyond-tabs', {hash: 3249066163, creator: function (require, exports) {
"use strict";
...
/*bundle*/function BeyondTabs(props) {
...
ims.set('./context', {hash: 1648631947, creator: function (require, exports) {
"use strict";
...
/*bundle*/function TabsContextProvider(props) {
  const {
    children,
    orientation,
    className,
...
/*bundle*/const useTabsContext = () => (0, React.useContext)(TabsContext);
...
ims.set('./tab', {hash: 3372983495, creator: function (require, exports) {
"use strict";
...
ims.set('./tabs-content', {hash: 3319265128, creator: function (require, exports) {
"use strict";
...
var React = require("react");
var _context = require("./context");
/*bundle*/function TabsContent(props) {
...
ims.set('./tabs', {hash: 2023887105, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./beyond-tabs","from":"BeyondTabs","name":"BeyondTabs"},{"im":"./context","from":"TabsContextProvider","name":"TabsContextProvider"},{"im":"./context","from":"useTabsContext","name":"useTabsContext"},{"im":"./tab","from":"BeyondTab","name":"BeyondTab"},{"im":"./tabs-content","from":"TabsContent","name":"TabsContent"},{"im":"./tabs","from":"Tabs","name":"Tabs"}];

export let BeyondTabs, TabsContextProvider, useTabsContext, BeyondTab, TabsContent, Tabs;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'BeyondTabs') && (BeyondTabs = require ? require('./beyond-tabs').BeyondTabs : value);
    (require || prop === 'TabsContextProvider') && (TabsContextProvider = require ? require('./context').TabsContextProvider : value);
    (require || prop === 'useTabsContext') && (useTabsContext = require ? require('./context').useTabsContext : value);
    (require || prop === 'BeyondTab') && (BeyondTab = require ? require('./tab').BeyondTab : value);
    (require || prop === 'TabsContent') && (TabsContent = require ? require('./tabs-content').TabsContent : value);
    (require || prop === 'Tabs') && (Tabs = require ? require('./tabs').Tabs : value);
...
//# sourceMappingURL=tabs.browser.mjs.map