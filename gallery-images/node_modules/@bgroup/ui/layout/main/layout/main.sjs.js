System.register(["@beyond-js/widgets/render", "@beyond-js/kernel/bundle", "@beyond-js/kernel/styles", "react", "@bgroup/ui/icons", "@beyond-js/kernel/routing", "@bgroup/ui/perfect-scrollbar", "@beyond-js/react-widgets/base", "@bgroup/ui/toast"], function (_export, _context) {
  "use strict";

  var dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8, __Bundle, __pkg, ims, Controller, __beyond_pkg, hmr;
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@bgroup/ui@0.0.34/layout/main"
        },
        "type": "widget"
      }, _context.meta.url).package();
      ;
      __pkg.dependencies.update([['@beyond-js/widgets/render', dependency_0], ['@beyond-js/kernel/styles', dependency_2], ['react', dependency_3], ['@bgroup/ui/icons', dependency_4], ['@beyond-js/kernel/routing', dependency_5], ['@bgroup/ui/perfect-scrollbar', dependency_6], ['@beyond-js/react-widgets/base', dependency_7], ['@bgroup/ui/toast', dependency_8]]);
      brequire('@beyond-js/widgets/render').widgets.register([{
        "name": "main-layout",
        "vspecifier": "@bgroup/ui@0.0.34/layout/main",
        "is": "layout"
      }]);
      brequire('@beyond-js/kernel/styles').styles.register('@bgroup/ui@0.0.34/layout/main');
      ims = new Map();
      /*******************************
      ...
      *****************************/
      ...
      ims.set('./views/index', {
        ...
        creator: function (require, exports) {
          ...
          function Layout() {
            return React.createElement("main", null, React.createElement(_sidebar.Sidebar, null), React.createElement(_toast.Toasts, {
              position: {
                bottom: '2rem',
                right: '2rem'
              }
