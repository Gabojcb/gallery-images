define(["exports", "module", "@beyond-js/kernel/bundle", "@beyond-js/kernel/styles", "react"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2) {
  ...
  _exports.hmr = _exports.__beyond_pkg = _exports.InputCode = void 0;
  const {
    Bundle: __Bundle
  } = dependency_0;
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@bgroup/ui@0.0.34/code-verification"
    },
    "type": "code",
  ...
  brequire('@beyond-js/kernel/styles').styles.register('@bgroup/ui@0.0.34/code-verification');
  const ims = new Map();
  ...
  ***********************/
  ...
  // Module exports
  _exports.InputCode = InputCode;
  __pkg.exports.process = function ({
    require,
    prop,
    value
  }) {
    (require || prop === 'InputCode') && (_exports.InputCode = InputCode = require ? require('./code-input').InputCode : value);
  };
...
//# sourceMappingURL=code-verification.amd.js.map