...
const __pkg = new __Bundle({"module":{"vspecifier":"@bgroup/ui@0.0.34/perfect-scrollbar"},"type":"code","name":"perfect-scrollbar"}, import.meta.url).package();;
...
ims.set('./container', {hash: 347674479, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./container","from":"BeyondScrollContainer","name":"BeyondScrollContainer"}];

export let BeyondScrollContainer;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'BeyondScrollContainer') && (BeyondScrollContainer = require ? require('./container').BeyondScrollContainer : value);
