System.register(["@beyond-js/widgets/render", "@beyond-js/kernel/bundle", "@beyond-js/react-widgets/page", "react", "@bgroup/ui/header", "@bgroup/ui/copyable-implementation", "@bgroup/ui/modal"], function (_export, _context) {
  "use strict";

  var dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, __Bundle, __pkg, ims, Controller, View, __beyond_pkg, hmr;
  _export({
    Controller: void 0,
    View: void 0
  });
  return {
    ...
    }, function (_bgroupUiModal) {
      dependency_6 = _bgroupUiModal;
    }],
    execute: function () {
      ({
        Bundle: __Bundle
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@bgroup/ui@0.0.34/beyond-alert-modal"
        },
        "type": "widget"
...
//# sourceMappingURL=beyond-alert-modal.sjs.js.map