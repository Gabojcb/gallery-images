...
const __pkg = new __Bundle({"module":{"vspecifier":"@bgroup/ui@0.0.34/beyond-alert-modal"},"type":"widget"}, import.meta.url).package();;
...
brequire('@beyond-js/widgets/render').widgets.register([{"name":"beyond-alert-modal","vspecifier":"@bgroup/ui@0.0.34/beyond-alert-modal","is":"page","route":"/components/beyond-alert-modal"}]);
...
ims.set('./views/implementation', {hash: 727061625, creator: function (require, exports) {
"use strict";
...
ims.set('./views/index', {hash: 3403167124, creator: function (require, exports) {
"use strict";
...
/*bundle*/function View() {
  ...
  }, React.createElement("h3", null, "Import:"), React.createElement(_copyableImplementation.CopyableImplementation, null, `import { BeyondConfirmModal } from '@bgroup/ui/modal';`)), React.createElement("div", {
...
ims.set('./views/results', {hash: 2847677487, creator: function (require, exports) {
"use strict";
...
//# sourceMappingURL=beyond-alert-modal.browser.mjs.map