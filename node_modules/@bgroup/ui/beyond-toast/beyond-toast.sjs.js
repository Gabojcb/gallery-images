System.register(["@beyond-js/widgets/render", "@beyond-js/kernel/bundle", "@beyond-js/react-widgets/page", "react", "@bgroup/ui/header", "@bgroup/ui/toast", "@bgroup/ui/copyable-implementation", "@bgroup/ui/form", "@bgroup/ui/implementation-result", "@beyond-js/kernel/styles"], function (_export, _context) {
  "use strict";

  var dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, dependency_8, dependency_9, __Bundle, __pkg, ims, Controller, Page, View, __beyond_pkg, hmr;
  _export({
    Controller: void 0,
    Page: void 0,
    View: void 0
  ...
  return {
    setters: [function (_beyondJsWidgetsRender) {
      ...
      dependency_4 = _bgroupUiHeader;
    }, function (_bgroupUiToast) {
      dependency_5 = _bgroupUiToast;
    }, function (_bgroupUiCopyableImplementation) {
      dependency_6 = _bgroupUiCopyableImplementation;
    }, function (_bgroupUiForm) {
      dependency_7 = _bgroupUiForm;
    }, function (_bgroupUiImplementationResult) {
      dependency_8 = _bgroupUiImplementationResult;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@bgroup/ui@0.0.34/beyond-toast"
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@bgroup/ui@0.0.34/beyond-toast');
      ims = new Map();
      /****************************
      ...
      **************************************/
      ...
      ims.set('./views/implementation', {
        ...
        creator: function (require, exports) {
          ...
          exports.implementationWaring = exports.implementationSuccess = exports.implementationLoading = exports.implementationInfo = exports.implementationError = exports.implementation2 = exports.implementation = void 0;
      ...
      *****************************/
      ...
      ims.set('./views/index', {
        ...
        creator: function (require, exports) {
          ...
          /*bundle*/
          function Page() {
            return React.createElement(_view.View, null);
          }
        }
      });
        ...
        creator: function (require, exports) {
          ...
          function View() {
            function toggleToast(event) {
              ...
              _toast.toast[dataset.type](dataset.message);
            }
            return React.createElement("div", null, React.createElement("div", {
            ...
            }, React.createElement("h3", null, "Import:"), React.createElement(_copyableImplementation.CopyableImplementation, null, `import { Toasts, toast } from '@bgroup/ui/toast';`)), React.createElement("div", {
              ...
              className: "btn btn-primary",
              onClick: toggleToast
            }, "Show info Toast")), React.createElement(_implementationResult.ImplementationResult, {
              code: _implementation.implementationLoading
            }, React.createElement(_form.BeyondButton, {
              "data-type": "loading",
...
//# sourceMappingURL=beyond-toast.sjs.js.map