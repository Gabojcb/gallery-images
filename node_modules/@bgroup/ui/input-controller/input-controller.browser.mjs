...
const __pkg = new __Bundle({"module":{"vspecifier":"@bgroup/ui@0.0.34/input-controller"},"type":"code"}, import.meta.url).package();;
...
ims.set('./index', {hash: 3919871860, creator: function (require, exports) {
"use strict";
...
ims.set('./input-components', {hash: 2354356184, creator: function (require, exports) {
"use strict";
...
/*bundle*/const inputComponents = new InputComponents();
...
ims.set('./inputs/check-and-radios', {hash: 3403928382, creator: function (require, exports) {
"use strict";
...
ims.set('./inputs/default', {hash: 1333658770, creator: function (require, exports) {
"use strict";
...
ims.set('./inputs/select', {hash: 1243619150, creator: function (require, exports) {
"use strict";
...
ims.set('./inputs/textarea', {hash: 562440940, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./index","from":"Component","name":"Component"},{"im":"./input-components","from":"inputComponents","name":"inputComponents"}];

export let Component, inputComponents;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'Component') && (Component = require ? require('./index').Component : value);
    (require || prop === 'inputComponents') && (inputComponents = require ? require('./input-components').inputComponents : value);
...
//# sourceMappingURL=input-controller.browser.mjs.map