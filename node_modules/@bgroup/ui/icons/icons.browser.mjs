...
const __pkg = new __Bundle({"module":{"vspecifier":"@bgroup/ui@0.0.34/icons"},"type":"code","name":"icon"}, import.meta.url).package();;
...
ims.set('./beyond-icon-button', {hash: 475425774, creator: function (require, exports) {
"use strict";
...
/*bundle*/const BeyondIconButton = (0, _react.forwardRef)((props, ref) => {
  const {
    icon,
    onClick,
    viewBox,
...
ims.set('./icon', {hash: 270830895, creator: function (require, exports) {
"use strict";
...
ims.set('./icons', {hash: 2390027247, creator: function (require, exports) {
"use strict";
...
/*bundle*/const BEYOND_ICONS = {
  ...
  edit: {
    viewBox: '0 0 512 512',
    icon: `<g aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen-to-square" class="svg-inline--fa fa-pen-to-square" role="img" xmlns="http://www.w3.org/2000/svg"><path d="M383.1 448H63.1V128h156.1l64-64H63.1C28.65 64 0 92.65 0 128v320c0 35.35 28.65 64 63.1 64h319.1c35.34 0 63.1-28.65 63.1-64l-.0039-220.1l-63.1 63.99V448zM497.9 42.19l-28.13-28.14c-18.75-18.75-49.14-18.75-67.88 0l-38.62 38.63l96.01 96.01l38.62-38.63C516.7 91.33 516.7 60.94 497.9 42.19zM147.3 274.4l-19.04 95.22c-1.678 8.396 5.725 15.8 14.12 14.12l95.23-19.04c4.646-.9297 8.912-3.213 12.26-6.562l186.8-186.8l-96.01-96.01L153.8 262.2C150.5 265.5 148.2 269.8 147.3 274.4z"></path></g>`
  },
  'address-card': {
    viewBox: '0 0 576 512',
  ...
  operations: {
    ...
    <path d="M3.755,100.933c.367.087.743.183,1.13.27a.156.156,0,0,0,.135-.087c.164-.348.319-.7.473-1.033.377-.058.763-.106,1.149-.183a4.878,4.878,0,0,0,.531-.174.152.152,0,0,1,.116.01.142.142,0,0,1,.01.126c-.058.154-.126.309-.193.463a.188.188,0,0,1-.1.1q-.492.116-.985.2a.193.193,0,0,0-.164.116c-.154.319-.309.628-.463.936a.263.263,0,0,1-.309.164,6.293,6.293,0,0,1-1.834-.492.145.145,0,0,1-.1-.154c.019-.386.029-.772.039-1.159a.249.249,0,0,0-.068-.154c-.251-.222-.512-.434-.772-.647a.246.246,0,0,0-.164-.039l-1.159.232a.156.156,0,0,1-.126-.058,5.79,5.79,0,0,1-.83-1.844.178.178,0,0,1,.048-.154c.3-.232.608-.463.917-.685a.2.2,0,0,0,.106-.193c0-.328.01-.647.029-.975a.2.2,0,0,0-.087-.183c-.3-.241-.579-.492-.879-.734a.151.151,0,0,1-.048-.183,5.959,5.959,0,0,1,.908-1.757.162.162,0,0,1,.193-.077q.55.159,1.1.29a.219.219,0,0,0,.174-.048c.261-.193.521-.4.782-.579a.2.2,0,0,0,.1-.193c0-.367.01-.743.019-1.11a.167.167,0,0,1,.135-.174,6.079,6.079,0,0,1,1.7-.367.554.554,0,0,1,.116.01c-.087.193-.164.386-.251.56-.01.029-.068.048-.106.058-.3.068-.6.126-.9.183-.087.019-.135.058-.135.154.01.328.019.666.039.994.01.116,0,.183-.126.241a3.678,3.678,0,0,0-1.216.927.154.154,0,0,1-.2.048c-.357-.126-.724-.251-1.12-.386L.84,94.281c-.019.029.01.116.048.145.28.212.56.425.84.628a.147.147,0,0,1,.087.183,3.9,3.9,0,0,0-.048,1.6c.01.039-.039.106-.087.135-.29.193-.579.386-.879.579a.13.13,0,0,0-.058.183l.434.956a.125.125,0,0,0,.164.077c.338-.087.676-.174,1.014-.27a.144.144,0,0,1,.193.058,3.873,3.873,0,0,0,1.149.985c.135.068.135.154.116.27-.039.338-.058.676-.087,1.014A.235.235,0,0,1,3.755,100.933Z" transform="translate(-0.075 -81.67)"></path>
    <path d="M232.92,95.166c.319-.232.628-.454.936-.676a.145.145,0,0,0,.058-.222c-.154-.309-.3-.608-.444-.917-.029-.068-.068-.1-.164-.077-.377.106-.753.212-1.11.309-.251-.232-.512-.473-.782-.7a3.74,3.74,0,0,0-.531-.328.164.164,0,0,1-.1-.193c.029-.338.048-.676.068-1.023a.133.133,0,0,0-.126-.164c-.29-.068-.579-.135-.859-.212a.189.189,0,0,1-.126-.077c-.087-.183-.174-.367-.27-.589.338.058.637.087.927.164.319.077.618.193.927.3a.2.2,0,0,1,.1.135c.01.386,0,.782.01,1.168a.216.216,0,0,0,.077.145c.251.212.512.415.772.618a.233.233,0,0,0,.174.039c.377-.077.753-.164,1.12-.261.077-.019.116.01.164.077a5.822,5.822,0,0,1,.859,1.776.15.15,0,0,1-.048.193c-.3.232-.6.473-.9.7a.163.163,0,0,0-.077.164c.01.328.01.666,0,.994a.2.2,0,0,0,.087.183c.3.222.589.463.888.685a.155.155,0,0,1,.058.2,5.976,5.976,0,0,1-.85,1.767.146.146,0,0,1-.193.077c-.377-.1-.743-.183-1.12-.261a.22.22,0,0,0-.154.039c-.27.212-.531.425-.8.637a.205.205,0,0,0-.068.145c0,.377.01.763.019,1.139,0,.106-.048.145-.135.183a5.843,5.843,0,0,1-1.941.434.168.168,0,0,1-.116-.058c-.174-.348-.348-.7-.512-1.062a.189.189,0,0,0-.154-.126q-.3-.043-.608-.116a.192.192,0,0,1-.116-.077c-.1-.212-.183-.434-.261-.637.319.077.647.154.975.222a3.436,3.436,0,0,0,.454.048c.1,0,.126.039.154.126.126.319.251.628.377.946.039.087.077.135.193.106l.994-.232a.131.131,0,0,0,.116-.164c-.019-.328-.039-.647-.068-.975a.235.235,0,0,1,.135-.27,3.616,3.616,0,0,0,1.159-.927.17.17,0,0,1,.232-.058c.319.106.647.193.975.29a.12.12,0,0,0,.164-.068c.145-.309.3-.618.454-.936a.143.143,0,0,0-.058-.212c-.28-.193-.56-.4-.84-.579-.068-.048-.106-.087-.087-.174A3.667,3.667,0,0,0,232.92,95.166Z" transform="translate(-205.634 -81.579)"></path>
    <path d="M32.281,120.718c-.3.135-.579.28-.869.4a2.242,2.242,0,0,1-.454.058,2.125,2.125,0,0,0-1.467.956,2.222,2.222,0,0,0,.405,2.935,2.2,2.2,0,0,0,1.622.521,2.712,2.712,0,0,1,.473.048l.888.087a2.791,2.791,0,0,1-3.4-.232,2.814,2.814,0,0,1,2.8-4.769Z" transform="translate(-25.782 -108.908)"></path>
    <path d="M226.6,125.7c.492-.019.985-.068,1.467-.048a2.292,2.292,0,0,0,2.336-1.912,2.253,2.253,0,0,0-1.844-2.52.284.284,0,0,1-.1-.029c-.348-.154-.685-.319-1.033-.473a2.787,2.787,0,0,1,3.031,1.014,2.827,2.827,0,0,1-.29,3.7A2.76,2.76,0,0,1,226.6,125.7Z" transform="translate(-204.73 -108.952)"></path>
    <path d="M115.494,102.127a3.814,3.814,0,1,1,3.833-3.794A3.82,3.82,0,0,1,115.494,102.127Zm0-.589a3.22,3.22,0,1,0-3.215-3.215A3.224,3.224,0,0,0,115.494,101.538Z" transform="translate(-100.923 -85.374)"></path>
</g>`
  },
  'menu-2': {
    viewBox: '0 0 30 30',
    icon: `<g>
      <defs>
        <clipPath id="clip-path">
          <rect id="Rectángulo_10" data-name="Rectángulo 10" width="30" height="30" transform="translate(-0.319 -0.191)" />
        </clipPath>
      </defs>
      <g id="Enmascarar_grupo_1" data-name="Enmascarar grupo 1" transform="translate(0.319 0.191)" clip-path="url(#clip-path)">
        <g id="menu-svgrepo-com" transform="translate(0 5.251)">
          <g id="Menu">
            <path id="Trazado_6412" data-name="Trazado 6412" d="M.909,9.132H28.188a.988.988,0,0,0,.909-1.05.988.988,0,0,0-.909-1.05H.909A.988.988,0,0,0,0,8.082.988.988,0,0,0,.909,9.132Z" transform="translate(0 -7.031)"  opacity="0.82"/>
            <path id="Trazado_6413" data-name="Trazado 6413" d="M22.593,21.094H.729c-.4,0-.729.471-.729,1.05s.327,1.05.729,1.05H22.593c.4,0,.729-.471.729-1.05S23,21.094,22.593,21.094Z" transform="translate(0 -11.524)"  opacity="0.82"/>
            <path id="Trazado_6414" data-name="Trazado 6414" d="M28.188,35.156H.909a1.061,1.061,0,0,0,0,2.1H28.188a1.061,1.061,0,0,0,0-2.1Z" transform="translate(0 -16.016)"  opacity="0.82"/>
          </g>
        </g>
      </g>
    </g>`
  ...
  pencil: {
    viewBox: '0 0 19.975 20.069',
    icon: `<g>
      <g id="editar" transform="translate(0 0)">
        <path id="Trazado_10853" data-name="Trazado 10853" d="M.4,20.2l.3-.9c.5-1.7,1.1-3.4,1.6-5.1v-.1l4.2,4.2a.31.31,0,0,0-.2.1L.6,20.2c-.1,0-.1.1-.2,0Z" transform="translate(-0.4 -0.175)" />
        <path id="Trazado_10854" data-name="Trazado 10854" d="M8,16.8,3.8,12.6l9.7-9.7,4.2,4.2Z" transform="translate(-0.4 -0.175)" />
        <path id="Trazado_10855" data-name="Trazado 10855" d="M19.2,5.6,15,1.4a9.428,9.428,0,0,1,1-1,.91.91,0,0,1,1.2,0c.1,0,.1.1.2.2L20,3.2a1.041,1.041,0,0,1,0,1.6A6.034,6.034,0,0,1,19.2,5.6Z" transform="translate(-0.4 -0.175)" />
      </g>
    </g>`
  },
  detail: {
    viewBox: '0 0 21.429 20.647',
    icon: `<g>
      <g id="detalle" transform="translate(0 0)">
        <path id="Trazado_10850" data-name="Trazado 10850" d="M9.2.2V4.6c0,.4.2.6.8.6h4.3V6.7c-.3,0-.5-.1-.8-.1a5.226,5.226,0,0,0-3.6,1c-.1.2-.3.2-.5.2h-6a.669.669,0,0,0-.7.6c0,.4.3.6.7.6H8.6a4.514,4.514,0,0,0-.7,2.5H3.5c-.5,0-.9.5-.6.9a.713.713,0,0,0,.6.3H7.9c.2,0,.3,0,.3.2A4.648,4.648,0,0,0,9.5,15l.2.2H3.5a.6.6,0,1,0,0,1.2h9.7c.4,0,.8-.1,1.2-.1v3.2c0,.5-.2.7-.7.7H1a.645.645,0,0,1-.6-.6V.4A.53.53,0,0,1,1-.2H9.2C9.1.2,9.1.2,9.2.2ZM5.3,4H3.4a.548.548,0,0,0-.6.4c-.2.4.2.8.7.8H7.2a.669.669,0,0,0,.7-.6c0-.4-.3-.6-.7-.6Z" transform="translate(-0.4 0.2)" />
        <path id="Trazado_10851" data-name="Trazado 10851" d="M17,14.7a.668.668,0,0,1,1,.1l3.4,3.4a1.267,1.267,0,0,1,.1,1.8,1.248,1.248,0,0,1-1.7.2c-.1-.1-.2-.1-.3-.2l-3.4-3.4c-.4-.4-.4-.6-.1-1l-.8-.8H15a4.645,4.645,0,0,1-2.3.6,3.722,3.722,0,0,1-3.5-3.2,3.842,3.842,0,0,1,2.5-4.1,3.785,3.785,0,0,1,5.1,3.7,3.292,3.292,0,0,1-.6,1.9.187.187,0,0,0,0,.3C16.5,14.2,16.7,14.5,17,14.7Z" transform="translate(-0.4 0.2)" />
        <path id="Trazado_10852" data-name="Trazado 10852" d="M10.5.6l3.3,3.3H10.5Z" transform="translate(-0.4 0.2)" />
      </g>
    </g>`
  },
  profile: {
    viewBox: '0 0 31.002 27.613',
    icon: `<g>
      <g id="Componente_45_1" data-name="Componente 45 – 1" transform="translate(0.3 0.3)">
        <path id="Trazado_9231" data-name="Trazado 9231" d="M.123,12.254c.051-.235.1-.471.158-.706A4.6,4.6,0,0,1,4.489,7.921a20.55,20.55,0,0,1,2.945.164,3.127,3.127,0,0,1,1.7.94c-.082.1-.15.2-.224.278a10.874,10.874,0,0,0-2.534,5.945,41.149,41.149,0,0,0-.146,5.561c.008.706,0,1.415,0,2.166a3.8,3.8,0,0,1-.448.047c-1.189,0-2.375.007-3.564-.007A2.013,2.013,0,0,1,.179,21.36a.352.352,0,0,0-.056-.085Q.123,16.768.123,12.254Z" transform="translate(-0.123 3.989)"  stroke="#4e5256" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.6" fill-rule="evenodd"/>
        <path id="Trazado_9232" data-name="Trazado 9232" d="M21.52,21.185a.962.962,0,0,0-.072.156,2.018,2.018,0,0,1-1.86,1.626c-1.314.049-2.629.022-3.947.022a1.631,1.631,0,0,1-.262-.054v-.4c0-1.883.037-3.77,0-5.654a11.591,11.591,0,0,0-1.72-6.268c-.355-.534-.749-1.032-1.149-1.574a3.51,3.51,0,0,1,1.78-.96,9.225,9.225,0,0,1,3.652-.02,4.715,4.715,0,0,1,3.516,4,1.54,1.54,0,0,0,.064.2Q21.521,16.728,21.52,21.185Z" transform="translate(8.883 4.017)"  stroke="#4e5256" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.6" fill-rule="evenodd"/>
        <path id="Trazado_9233" data-name="Trazado 9233" d="M11.134,23.358q-2.466,0-4.935,0a1.883,1.883,0,0,1-1.4-.519,2.3,2.3,0,0,1-.7-1.653c-.015-1.857-.057-3.713.007-5.564.107-3.137,1.329-5.481,3.718-6.9a5.821,5.821,0,0,1,2.622-.792,9.9,9.9,0,0,1,3.471.23c2.521.734,4.663,3.63,4.835,6.708.12,2.128.055,4.27.048,6.405a2.87,2.87,0,0,1-.212.891A1.331,1.331,0,0,1,17.5,23.17c-.919.111-1.846.186-2.768.214-1.2.038-2.4.008-3.6.008Z" transform="translate(3.749 3.61)"  stroke="#4e5256" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.6" fill-rule="evenodd"/>
        <path id="Trazado_9234" data-name="Trazado 9234" d="M10.382,1.105A4.737,4.737,0,1,1,5.653,5.854,4.731,4.731,0,0,1,10.382,1.105Z" transform="translate(4.802 -1.105)"  stroke="#4e5256" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.6" fill-rule="evenodd"/>
        <path id="Trazado_9235" data-name="Trazado 9235" d="M7.516,6.48A3.287,3.287,0,1,1,4.225,3.2,3.3,3.3,0,0,1,7.516,6.48Z" transform="translate(1.223 0.373)"  stroke="#4e5256" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.6" fill-rule="evenodd"/>
        <path id="Trazado_9739" data-name="Trazado 9739" d="M7.516,6.48A3.287,3.287,0,1,1,4.225,3.2,3.3,3.3,0,0,1,7.516,6.48Z" transform="translate(20.71 0.373)"  stroke="#4e5256" stroke-linecap="round" stroke-linejoin="round" stroke-width="0.6" fill-rule="evenodd"/>
      </g>
    </g>`
  },
  delete: `<g id="delete">
  ...
  'trash-gt': {
    viewBox: '0 0 20 20',
    icon: `<g>
            <path d="M17.5,3h-2h-11h-2c-0.6,0-1,0.4-1,1c0,0.6,0.4,1,1,1h1v14c0,0.6,0.4,1,1,1h11c0.6,0,1-0.4,1-1V5h1
              c0.6,0,1-0.4,1-1C18.5,3.5,18.1,3,17.5,3z M14.5,15h-9V5h9V15z"/>
            <path  d="M14.5,1c0-0.6-0.4-1-1-1h-7c-0.6,0-1,0.4-1,1v1h9V1z"/>
          </g>`
  },
  filter: {
    viewBox: '0 0 17.837 18',
    icon: `<g>
            <path id="filtro-2" data-name="filtro" d="M1.261.531H17.8A2.275,2.275,0,0,1,18.123.7a.868.868,0,0,1,.038,1.322c-2.135,2.294-4.254,4.6-6.384,6.9a1.387,1.387,0,0,0-.391,1c.009,1.558,0,3.116.008,4.672a1.457,1.457,0,0,1-.371,1.025c-.741.838-1.47,1.688-2.21,2.526a4.132,4.132,0,0,1-.444.383H8.124a.647.647,0,0,1-.451-.7c0-2.622,0-5.246.007-7.868A1.463,1.463,0,0,0,7.264,8.9q-2.6-2.8-5.188-5.615c-.405-.439-.809-.88-1.216-1.316a.831.831,0,0,1-.178-.94A.921.921,0,0,1,1.261.531Z" transform="translate(-0.609 -0.531)" fill-rule="evenodd"/>
          </g>`
  },
  check: {
    viewBox: '0 0 18.436 14.061',
    icon: `<g>
            <path id="check" d="M5.85,16.316,17.01,5.156l1.426,1.475L5.851,19.217,0,13.366l1.475-1.475Z" transform="translate(0 -5.156)"/>
          </g>`
  },
  'cancel-line': {
    viewBox: '0 0 16 16',
    icon: `<g >
            <path id="cancel-line" d="M10,2a8,8,0,1,0,8,8A8,8,0,0,0,10,2ZM3,10A6.965,6.965,0,0,1,4.715,5.425l9.86,9.86A7,7,0,0,1,3,10Zm12.285,4.575-9.86-9.86a7,7,0,0,1,9.86,9.86Z" transform="translate(-2 -2)"/>
          </g>`
  },
  amazon: {
    icon: `<g>
    <g id="Grupo_3505" data-name="Grupo 3505" transform="translate(3.329 0)">
      <path id="Trazado_10913" data-name="Trazado 10913" d="M14.15,6.762c-.046-.046-.092-.092-.092-.137a1.761,1.761,0,0,1-.412-1.236V2.872a5.834,5.834,0,0,0-.046-.915A1.871,1.871,0,0,0,12.732.584a3.3,3.3,0,0,0-1.6-.5A4.631,4.631,0,0,0,9.208.31,2.491,2.491,0,0,0,7.469,2.232c-.046.183.046.275.275.32.412.046.869.092,1.281.137.229,0,.32-.046.366-.275a1.1,1.1,0,0,1,.5-.686,1.269,1.269,0,0,1,.915-.137.832.832,0,0,1,.732.778c.046.229,0,.5.046.732,0,.046-.046.046-.092.092-.458.046-.961.092-1.419.137A5.9,5.9,0,0,0,8.8,3.7,2.371,2.371,0,0,0,7.378,5.3a2.339,2.339,0,0,0,0,1.373,1.808,1.808,0,0,0,1.19,1.419A3.17,3.17,0,0,0,10.9,8a2.847,2.847,0,0,0,.869-.641c.137-.137.137-.137.229.046a2.3,2.3,0,0,0,.641.686c.229.183.32.183.549,0a2.961,2.961,0,0,0,.412-.366,6.846,6.846,0,0,1,.595-.5A.352.352,0,0,0,14.15,6.762ZM11.542,4.84A2.336,2.336,0,0,1,11.4,5.8a1.451,1.451,0,0,1-.686.869.841.841,0,0,1-.732.092.787.787,0,0,1-.5-.5,1.519,1.519,0,0,1,0-1.007,1.314,1.314,0,0,1,.824-.732,2.138,2.138,0,0,1,.778-.137.892.892,0,0,0,.366-.046c.092,0,.092,0,.092.092Z" transform="translate(-7.275 -0.065)" />
    </g>
    <path id="Trazado_10914" data-name="Trazado 10914" d="M.229,18.151,0,17.922v-.046c0-.046.046-.137.183-.092a12.606,12.606,0,0,0,6.269,1.693c3.661.046,4.988-.915,4.988-.915s.32-.183.458-.046.046.229-.046.32a9.664,9.664,0,0,1-5.445,1.6A11.352,11.352,0,0,1,.229,18.151Z" transform="translate(0 -9.67)" fill="#f6a51f"/>
    <path id="Trazado_10915" data-name="Trazado 10915" d="M23.483,17.905s-.183.046-.183-.092c0-.092.595-.641,2.013-.458,0,0,.458,0,.458.275a2.935,2.935,0,0,1-.869,2.013s-.229.092-.183-.092a7,7,0,0,0,.458-1.464s.046-.229-.458-.275A4.853,4.853,0,0,0,23.483,17.905Z" transform="translate(-12.638 -9.424)" fill="#f6a51f"/>
  </g>`,
    viewBox: '0 0 13.133 10.769'
  },
  dollar: {
    viewBox: '0 0 320 512',
    icon: `<g >
  ...
  'exclamation-gt': {
    viewBox: '0 0 13 13',
    icon: `<g>
    <path id="info" d="M9.5,14.7A5.2,5.2,0,1,0,4.3,9.5,5.2,5.2,0,0,0,9.5,14.7Zm0,1.3A6.5,6.5,0,1,1,16,9.5,6.5,6.5,0,0,1,9.5,16ZM8.85,8.85v3.9h1.3V8.85Zm0-2.6h1.3v1.3H8.85Z" transform="translate(16 16) rotate(180)" />
  </g>
  `
  },
  search: `<g id="search" transform="scale(0.04)">
                    <path d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z"></path>
                </g>`,
  'list-search': {
    viewBox: '0 0 24 24',
    icon: `<g ><path d="M3 17v2h6v-2H3zM3 5v2h10V5H3zm10 16v-2h8v-2h-8v-2h-2v6h2zM7 9v2H3v2h4v2h2V9H7zm14 4v-2H11v2h10zm-6-4h2V7h4V5h-4V3h-2v6z"></path></g>`
  },
  arrowDropDown: `<path d="M7 10l5 5 5-5z"></path>`,
  arrowDropUp: `<path d="M7 14l5-5 5 5z"></path>`,
  info: {
    viewBox: '0 0 192 512',
    icon: `<g >
  ...
  idcard: `<g transform="scale(0.75)">
	<path d="M27.296,6.498h-7.497V0h-7.724v6.498H4.579c-2.393,0-4.333,1.94-4.333,4.333v16.711c0,2.394,1.94,4.333,4.333,4.333
	h22.718c2.393,0,4.333-1.939,4.333-4.333V10.831C31.629,8.438,29.689,6.498,27.296,6.498z M14.038,1.962h3.8v6.367l-3.8,0.008
	V1.962z M19.111,26.596c0,0.635-0.516,1.151-1.151,1.151H5.789c-0.636,0-1.152-0.517-1.152-1.151v-1.012
	c0-2.014,1.633-3.646,3.647-3.646h0.942c0.489,0,0.885-0.396,0.885-0.885c0-0.183-0.073-0.355-0.203-0.482
	c-0.539-0.526-0.994-1.229-1.326-1.988c-0.056,0.033-0.117,0.051-0.183,0.051c-0.529,0-1.15-1.169-1.15-1.965
	c0-0.797,0.073-1.441,0.602-1.441c0.045,0,0.094,0.01,0.142,0.02c0.038-2.158,0.44-4.847,3.881-4.847
	c3.298,0,3.844,2.695,3.881,4.855c0.068-0.018,0.135-0.027,0.197-0.027c0.528,0,0.603,0.646,0.603,1.441s-0.622,1.965-1.151,1.965
	c-0.082,0-0.154-0.035-0.222-0.086c-0.333,0.771-0.794,1.489-1.341,2.021c-0.13,0.127-0.203,0.301-0.203,0.482
	c0,0.489,0.396,0.885,0.885,0.885h0.942c2.014,0,3.646,1.633,3.646,3.647V26.596z M27.238,25.291c0,0.471-0.381,0.854-0.852,0.854
	h-6.215v-0.561c0-0.919-0.27-1.775-0.727-2.5h6.941c0.471,0,0.852,0.382,0.852,0.854V25.291z M27.238,19.714
	c0,0.472-0.381,0.853-0.852,0.853H15.758v-0.811c0.025-0.044,0.053-0.084,0.078-0.129c0.821-0.255,1.417-1.209,1.658-2.121h8.892
	c0.471,0,0.852,0.383,0.852,0.854V19.714z M27.238,14.137c0,0.471-0.381,0.853-0.852,0.853h-9.1
	c-0.135-0.262-0.297-0.479-0.516-0.614c-0.088-0.993-0.299-1.795-0.593-2.447h10.208c0.471,0,0.852,0.382,0.852,0.854V14.137z"/>
	<circle cx="16.062" cy="4.209" r="0.875"/>
</g>`,
  upload: `<g><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z"></path></g>`,
  clip: `<g id="clip" transform="scale(0.035)">
...
<path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>
  ...
  attractions: `<g transform="translate(0,-1028.3623)">
		<path
		d="m 12.481103,1050.931 c 0.713543,-3.0826 1.27272,-6.8842 1.046055,-7.1116 -0.04871,-0.049 -0.312521,0.187 -0.586225,0.5242 -1.293981,1.5942 -2.946998,2.4082 -4.20321,2.07 -0.699004,-0.1882 -1.476491,-0.9507 -1.928492,-1.8911 -0.426639,-0.8877 -0.815162,-2.2076 -0.721593,-2.4514 0.06208,-0.1618 1.359543,-0.5964 1.465181,-0.4907 0.03041,0.03 0.197237,0.3917 0.370698,0.8029 0.597794,1.4168 1.01805,1.7847 1.794139,1.5704 0.888845,-0.2454 1.673287,-1.4352 1.934271,-2.9339 0.104053,-0.5975 0.0952,-0.951 -0.04404,-1.7579 -0.207443,-1.2021 -0.777814,-2.5189 -1.090056,-2.5165 -0.409771,0 -2.159933,0.6829 -2.446114,0.9501 -0.438348,0.4095 -0.649437,0.8957 -0.724727,1.6695 l -0.06802,0.6989 -0.670334,0.1061 c -0.368684,0.058 -0.703363,0.074 -0.743729,0.033 -0.09638,-0.097 0.148846,-2.5763 0.310693,-3.1421 0.272051,-0.951 1.311791,-1.6474 3.628737,-2.4303 0.937353,-0.3168 1.31715,-0.3781 2.775155,-0.4476 1.184602,-0.056 1.828376,-0.1403 2.155156,-0.2801 1.241021,-0.531 1.900173,-1.8569 1.768976,-3.5581 -0.03786,-0.491 -0.100097,-0.9741 -0.138303,-1.0737 -0.04851,-0.1264 0.09925,-0.2908 0.489617,-0.5448 l 0.559094,-0.3637 0.252899,0.7494 c 0.3551,1.052 0.546921,2.3725 0.47495,3.2693 -0.08543,1.0643 -0.618845,2.1075 -1.543372,3.0185 -0.643902,0.6345 -0.710759,0.7431 -0.61521,0.9987 0.546478,1.4628 0.705249,3.0475 0.556578,5.5555 -0.204087,3.4425 -0.652149,5.8263 -1.670153,8.8857 l -0.484561,1.4562 -1.117652,0.033 -1.117653,0.033 0.331242,-1.4312 z m -1.709447,-17.3784 c -0.49338,-0.215 -1.078627,-0.9208 -1.170774,-1.412 -0.238151,-1.2694 0.69311,-2.3864 1.989548,-2.3864 0.919401,0 1.673822,0.5962 1.922446,1.5197 0.412286,1.531 -1.262305,2.9231 -2.74122,2.2787 z"/>
	</g>`,
  send: `<g id="send">
...
<path
  ...
  favoriteBorder: `<g id="favorite-border">
			<path
				d="M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3zm-4.4 15.55l-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05z"></path>
		</g>`,
  mapMarker: `<g id="map-marker" transform="scale(0.0441)">
  ...
  chat: `<g id="chat"
transform="matrix(0.81805167,0,0,0.81805167,5.277e-8,4.090786e-4) scale(1.2)">
<path
  ...
  gallery: `<g id="gallery"
   transform="translate(0,-1028.3622)">
	<path
		id="path4614"
		d="m 2.4016879,1030.6645 c -0.641846,0 -1.237459,0.2532 -1.692993,0.7087 -0.455372,0.4554 -0.708695,1.0512 -0.708695,1.693 l 0,14.5901 c 0,0.642 0.253295,1.2395 0.708695,1.6949 0.455525,0.4552 1.051125,0.7087 1.692993,0.7087 l 19.1966251,0 c 0.641779,0 1.237598,-0.2533 1.692993,-0.7087 C 23.746593,1048.8959 24,1048.2985 24,1047.6563 l 0,-14.5901 c 0,-0.642 -0.25324,-1.2377 -0.708694,-1.693 -0.455322,-0.4554 -1.050983,-0.7087 -1.692993,-0.7087 l -19.1966251,0 z m 0.828685,1.2655 17.5392551,0 c 0.558197,0 1.075879,0.2208 1.47176,0.6169 0.395992,0.3959 0.616826,0.9135 0.616826,1.4717 l 0,12.6853 c 0,0.5584 -0.220974,1.0778 -0.616826,1.4736 -0.395945,0.396 -0.913763,0.6168 -1.47176,0.6168 l -17.5392551,0 c -0.558074,0 -1.075703,-0.2211 -1.47176,-0.6168 -0.395949,-0.3959 -0.616827,-0.9154 -0.616827,-1.4736 l 0,-12.6853 c 0,-0.558 0.220902,-1.0758 0.616827,-1.4717 0.396066,-0.396 0.913705,-0.6169 1.47176,-0.6169 z m 2.362315,2.023 c -0.667492,0 -1.235073,0.2336 -1.702367,0.7012 -0.467117,0.4673 -0.69932,1.0347 -0.69932,1.7024 0,0.6673 0.232071,1.2352 0.69932,1.7023 0.467294,0.4672 1.034875,0.6993 1.702367,0.6993 0.667581,0 1.235074,-0.2316 1.702367,-0.6993 0.467161,-0.4672 0.701195,-1.035 0.701195,-1.7023 0,-0.6676 -0.234164,-1.2351 -0.701195,-1.7024 -0.467293,-0.4671 -1.03483,-0.7012 -1.702367,-0.7012 z m 10.0135921,2.0023 -6.4082481,6.4083 -2.002344,-2.0023 -4.006562,4.0046 0,2.4036 17.6236231,0 0,-5.6077 -5.206469,-5.2065 z"
	></path>
</g>`,
  target: `<g id="target" transform="scale(0.2)">
<path d="m10.7,68.6h9c1.9,21.6 19.2,38.8 40.7,40.7v9c0,2.2 1.8,4.1 4.1,4.1 2.2,0 4.1-1.8 4.1-4.1v-9c21.6-1.9 38.8-19.2 40.7-40.7h9c2.2,0 4.1-1.8 4.1-4.1 0-2.2-1.8-4.1-4.1-4.1h-9c-1.9-21.6-19.2-38.8-40.7-40.7v-9c0-2.2-1.8-4.1-4.1-4.1-2.2,0-4.1,1.8-4.1,4.1v9c-21.6,1.9-38.8,19.2-40.7,40.7h-9c-2.3,0-4.1,1.8-4.1,4.1 3.55271e-15,2.3 1.9,4.1 4.1,4.1zm33.7-8.2h-16.5c1.9-17.1 15.5-30.7 32.5-32.5v16.5c0,2.2 1.8,4.1 4.1,4.1 2.2,0 4.1-1.8 4.1-4.1v-16.5c17.1,1.9 30.7,15.5 32.5,32.5h-16.5c-2.2,0-4.1,1.8-4.1,4.1 0,2.2 1.8,4.1 4.1,4.1h16.5c-1.9,17.1-15.5,30.7-32.5,32.5v-16.5c0-2.2-1.8-4.1-4.1-4.1-2.2,0-4.1,1.8-4.1,4.1v16.5c-17.1-1.9-30.7-15.5-32.5-32.5h16.5c2.2,0 4.1-1.8 4.1-4.1 0-2.2-1.9-4.1-4.1-4.1z"/>
  ...
  activeSurvey: `<g>
		<path
		   d="M 12 0 C 5.4893725 0 0.18657884 5.2116072 0.015625 11.681641 L 0.00390625 11.681641 L 0.00390625 11.919922 C 0.0037267888 11.946925 -1.4456029e-019 11.972955 0 12 C 0 12.029019 0.0033180187 12.05708 0.00390625 12.085938 L 0.015625 23.998047 L 11.990234 23.998047 C 11.993908 23.998249 11.996306 23.999823 12 24 C 12.013193 24 12.02588 23.99809 12.039062 23.998047 L 12.064453 23.998047 L 12.064453 23.996094 C 18.652665 23.960831 24 18.596367 24 12 C 24 5.3818515 18.618148 0 12 0 z M 12 1.5644531 C 17.772349 1.5644531 22.435547 6.227651 22.435547 12 C 22.435547 17.750574 17.80664 22.396641 12.064453 22.431641 L 12.064453 22.419922 L 1.5742188 22.419922 L 1.5742188 11.808594 C 1.6770396 6.1258811 6.292286 1.5644531 12 1.5644531 z M 11.667969 4.9140625 C 10.349723 4.9140625 9.2876561 5.2687356 8.4824219 5.9765625 C 7.6836815 6.6843893 7.2033612 7.7039222 7.0410156 9.0351562 C 6.8769531 10.425782 8.84375 10.312871 8.84375 9.2480469 C 8.9996017 8.2544918 9.3261474 7.5241959 9.8261719 7.0566406 C 10.326197 6.5890853 10.950477 6.3554688 11.697266 6.3554688 C 12.470031 6.3554686 13.121804 6.6152597 13.654297 7.1347656 C 14.186791 7.6477777 14.453125 8.2458829 14.453125 8.9277344 C 14.453125 9.3043762 14.363465 9.6505526 14.181641 9.96875 C 13.999814 10.286947 13.602607 10.716872 12.992188 11.255859 C 12.388262 11.788353 11.970106 12.193421 11.736328 12.472656 C 11.418131 12.855791 11.187786 13.236639 11.044922 13.613281 C 10.85011 14.113305 10.751953 14.706186 10.751953 15.394531 C 10.751953 15.51142 10.755219 15.688098 10.761719 15.921875 C 10.761719 16.867389 12.447266 16.790785 12.447266 15.921875 C 12.460256 15.220542 12.509326 14.714048 12.59375 14.402344 C 12.67817 14.090641 12.807089 13.81449 12.982422 13.574219 C 13.157755 13.333947 13.532059 12.959643 14.103516 12.453125 C 14.954207 11.699842 15.526137 11.061156 15.818359 10.535156 C 16.110581 10.009156 16.255859 9.433954 16.255859 8.8105469 C 16.255859 7.732572 15.840975 6.8144649 15.009766 6.0546875 C 14.178556 5.29491 13.064141 4.9140625 11.667969 4.9140625 z M 11.650391 17.351562 A 1.0895743 1.0895743 0 0 0 10.560547 18.441406 A 1.0895743 1.0895743 0 0 0 11.650391 19.53125 A 1.0895743 1.0895743 0 0 0 12.740234 18.441406 A 1.0895743 1.0895743 0 0 0 11.650391 17.351562 z "
		   />
	  </g>`,
  completeSurvey: `<g>
		<path d="M 12 0 C 5.4893725 0 0.1865788 5.2116071 0.015625 11.681641 L 0.00390625 11.681641 L 0.00390625 11.919922 C 0.00372675 11.946922 -2.8912058e-019 11.97295 0 12 C 0 12.02902 0.00331625 12.057077 0.00390625 12.085938 L 0.015625 23.998047 L 11.990234 23.998047 C 11.993934 23.998249 11.9963 23.9998 12 24 C 12.01319 24 12.025882 23.998147 12.039062 23.998047 L 12.064453 23.998047 L 12.064453 23.996094 C 18.652634 23.960874 24 18.596367 24 12 C 24 5.3818515 18.618148 -1.1842379e-015 12 0 z M 12 1.5644531 C 17.772349 1.5644531 22.435547 6.2276515 22.435547 12 C 22.435547 17.750574 17.80664 22.396641 12.064453 22.431641 L 12.064453 22.419922 L 1.5742188 22.419922 L 1.5742188 11.808594 C 1.6770396 6.1258812 6.292286 1.5644531 12 1.5644531 z M 16.523438 6.6992188 A 0.85008502 0.85008502 0 0 0 15.828125 7.078125 L 10.205078 15.271484 L 7.390625 12.599609 A 0.85008502 0.85008502 0 1 0 6.2207031 13.832031 L 10.478516 17.878906 L 17.228516 8.0410156 A 0.85008502 0.85008502 0 0 0 16.523438 6.6992188 z "/>
		</g>`,
  twitter: `<g id="twitter">
	<path
		d="M 24,4.5591056 C 23.116665,4.950518 22.16886,5.2159694 21.173015,5.3344794 22.18984,4.7255764 22.968194,3.7597709 23.337097,2.6124749 22.383291,3.1763582 21.330466,3.5858099 20.20866,3.807771 19.310345,2.8494557 18.032578,2.2525528 16.615321,2.2525528 c -2.718985,0 -4.923576,2.2045918 -4.923576,4.9220864 0,0.3854124 0.04349,0.7618444 0.12749,1.1218058 C 7.7280127,8.0909544 4.1002028,6.1308336 1.6721597,3.1523582 1.2477276,3.8782417 1.0062763,4.724047 1.0062763,5.6269112 c 0,1.7081989 0.8698445,3.215417 2.1896114,4.0972224 C 2.3890236,9.6971531 1.6301596,9.475192 0.9658056,9.1062502 v 0.06149 c 0,2.3845528 1.697689,4.3746738 3.9487515,4.8276158 -0.412432,0.110981 -0.8473347,0.172471 -1.297257,0.172471 -0.3179221,0 -0.6253736,-0.03149 -0.926825,-0.09149 0.6268637,1.95714 2.444553,3.380358 4.5981643,3.419378 -1.6841988,1.319767 -3.8078101,2.104121 -6.1143629,2.104121 -0.39741238,0 -0.788864,-0.024 -1.174276392125,-0.06749 C 2.1791017,20.931603 4.7661255,21.747447 7.5466006,21.747447 c 9.0567994,0 14.0073954,-7.50162 14.0073954,-14.0073951 L 21.537486,7.1026783 C 22.504782,6.4127556 23.341607,5.5459307 24,4.5591056 Z"></path>
</g>`,
  instagram: `<g id="instagram">
	<path
		d="M 21.599998,0 H 2.3999998 C 1.0799999,0 0,1.0799999 0,2.3999998 V 21.599998 c 0,1.32 1.0799999,2.4 2.3999998,2.4 H 21.599998 c 1.32,0 2.4,-1.08 2.4,-2.4 V 2.3999998 C 23.999998,1.0799999 22.919998,0 21.599998,0 Z m -9.599999,7.1999995 c 2.64,0 4.8,2.1599998 4.8,4.7999995 0,2.64 -2.16,4.8 -4.8,4.8 -2.6399997,0 -4.7999995,-2.16 -4.7999995,-4.8 0,-2.6399997 2.1599998,-4.7999995 4.7999995,-4.7999995 z M 2.9999998,21.599998 c -0.36,0 -0.6,-0.24 -0.6,-0.6 V 10.799999 h 2.5199998 c -0.12,0.36 -0.12,0.84 -0.12,1.2 0,3.96 3.2399998,7.2 7.1999994,7.2 3.96,0 7.2,-3.24 7.2,-7.2 0,-0.36 0,-0.84 -0.12,-1.2 h 2.519999 v 10.199999 c 0,0.36 -0.24,0.6 -0.6,0.6 z M 21.599998,5.3999996 c 0,0.36 -0.24,0.5999999 -0.6,0.5999999 h -2.399999 c -0.36,0 -0.6,-0.2399999 -0.6,-0.5999999 V 2.9999998 c 0,-0.36 0.24,-0.6 0.6,-0.6 h 2.399999 c 0.36,0 0.6,0.24 0.6,0.6 z"></path>
</g>`,
  facebook: `<g id="facebook"><g transform="translate(0,-1028.3622)">
<path
d="m 13.858645,1052.3622 0,-10.9467 3.67288,0 0.55105,-4.2674 -4.22393,0 0,-2.7241 c 0,-1.2352 0.34158,-2.0769 2.11475,-2.0769 l 2.25784,-9e-4 0,-3.8169 c -0.39046,-0.051 -1.73078,-0.1671 -3.29078,-0.1671 -3.25751,0 -5.48767,1.9884 -5.48767,5.6391 l 0,3.1468 -3.68402,0 0,4.2674 3.68402,0 0,10.9467 4.40586,0 z"
id="f_1_"></path>
</g></g>`,
  shoppingBag: `<g id="shoppingBag" transform="scale(0.12)">
...
transform="translate(0,-1028.3622)">
	<path
style="stroke-width:20.4119873"
d="m 1.2435407,1042.594 c -0.35273398,-3.7968 1.268861,-7.2359 3.958456,-9.4209 1.264479,-0.9159 3.194933,0.7464 1.998825,2.4838 -1.905742,1.553 -3.052127,4.0026 -2.772879,6.7069 0.362531,3.5224 3.184402,6.3737 6.7019413,6.7656 4.590438,0.5144 8.490105,-3.0815 8.490105,-7.5691 0,-2.3809 -1.102293,-4.512 -2.82187,-5.9083 -1.588742,-1.4386 0.484195,-3.8246 1.969431,-2.5083 2.459338,1.9841 4.036841,5.0167 4.036841,8.4166 0,6.217 -5.281208,11.2287 -11.596122,10.7731 -5.2224193,-0.3674 -9.4797203,-4.5268 -9.9647283,-9.7394 z m 10.7534803,-14.2318 c -0.881834,0 -1.592201,0.7153 -1.592201,1.5922 l 0,7.3339 c 0,0.8819 0.715266,1.5922 1.592201,1.5922 0.876935,0 1.592201,-0.7152 1.592201,-1.5922 l 0,-7.3339 c 0,-0.8769 -0.710367,-1.5922 -1.592201,-1.5922 z"
id="path4485"></path>
</g>`,
  pay: `<g>
<path d="M23.084,4.439L8.385,1.328c-0.622-0.131-1.238,0.27-1.37,0.892L6.736,4.015l16.959,3.589l0.279-1.795  C24.106,5.187,23.705,4.571,23.084,4.439z"/>
<path d="M16.902,7.984C16.73,7.366,16.084,7,15.467,7.172l-2.791,0.774L6.098,6.554L5.375,9.973l-4.52,1.254  c-0.618,0.171-0.984,0.817-0.812,1.435l2.547,9.18c0.171,0.619,0.818,0.984,1.436,0.813L18.638,18.6  c0.618-0.172,0.983-0.818,0.812-1.436l-0.437-1.576l1.639,0.346c0.622,0.133,1.238-0.27,1.37-0.891l1.037-4.9l-5.904-1.249  L16.902,7.984z M0.958,12.409c-0.031-0.113,0.038-0.234,0.15-0.266l4.043-1.122l9.541-2.648l1.027-0.285  c0.019-0.005,0.037-0.007,0.055-0.007c0.083,0,0.182,0.054,0.211,0.157l0.119,0.434l0.379,1.361l-15.028,4.17L0.958,12.409z   M18.59,12.649l0.361-1.708c0.055-0.256,0.309-0.42,0.563-0.367l1.708,0.362c0.256,0.054,0.421,0.308,0.367,0.563l-0.361,1.708  c-0.055,0.256-0.309,0.421-0.564,0.366l-1.707-0.361C18.701,13.158,18.535,12.905,18.59,12.649z M18.533,17.418  c0.02,0.069,0,0.127-0.021,0.162c-0.02,0.037-0.059,0.084-0.129,0.104L3.771,21.738c-0.019,0.005-0.038,0.008-0.056,0.008  c-0.083,0-0.181-0.055-0.209-0.158l-1.486-5.354l15.026-4.17l0.917,3.302L18.533,17.418z"/>
<path fill="none" d="M17.964,15.365l-0.917-3.302l-15.026,4.17l1.486,5.354c0.029,0.104,0.127,0.158,0.209,0.158  c0.018,0,0.037-0.003,0.056-0.008l14.611-4.055c0.07-0.02,0.109-0.066,0.129-0.104c0.021-0.035,0.041-0.093,0.021-0.162  L17.964,15.365z"/>
<path d="M6.132,17.783c-0.07-0.252-0.333-0.4-0.585-0.33l-1.707,0.473c-0.252,0.07-0.401,0.334-0.331,0.586l0.474,1.707  c0.07,0.252,0.333,0.4,0.585,0.33l1.707-0.473c0.252-0.07,0.401-0.334,0.331-0.586L6.132,17.783z"/>
</g> `,
  expandMore: `<g> <path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"></path></g>`,
  bell: `<g id="bell" transform="scale(0.04)">
<path  d="M224 512c35.32 0 63.97-28.65 63.97-64H160.03c0 35.35 28.65 64 63.97 64zm215.39-149.71c-19.32-20.76-55.47-51.99-55.47-154.29 0-77.7-54.48-139.9-127.94-155.16V32c0-17.67-14.32-32-31.98-32s-31.98 14.33-31.98 32v20.84C118.56 68.1 64.08 130.3 64.08 208c0 102.3-36.15 133.53-55.47 154.29-6 6.45-8.66 14.16-8.61 21.71.11 16.4 12.98 32 32.1 32h383.8c19.12 0 32-15.6 32.1-32 .05-7.55-2.61-15.27-8.61-21.71z"></path>
</g>`,
  comments: `<g id="comments" transform="scale(0.04)">
  ...
  paperPlane: `<g id="paperPlane" transform="scale(0.04)">
  ...
  arrowDownloads: {
    ...
    icon: `<g
	viewBox="0 0 10 10">
	<g transform="translate(0 -0.001)"><g transform="translate(1.783 0.001)">
	<path  d="M97.6,2.991l-2.9-2.9a.293.293,0,0,0-.414,0l-2.9,2.9a.293.293,0,0,0,0,.414l.829.829a.293.293,0,0,0,.414,0l.99-.99V7.275a.286.286,0,0,0,.293.285h1.172a.286.286,0,0,0,.293-.285V3.244l.99.99a.293.293,0,0,0,.414,0l.829-.829A.293.293,0,0,0,97.6,2.991Z" transform="translate(-91.289 -0.001)"/></g><g transform="translate(0 6.485)"><path  d="M9.707,332H9.046a.293.293,0,0,0-.293.293v1.976H1.247v-1.976A.293.293,0,0,0,.954,332H.293a.293.293,0,0,0-.293.293v2.344a.88.88,0,0,0,.879.879H9.121a.88.88,0,0,0,.879-.879v-2.344A.293.293,0,0,0,9.707,332Z" 
	transform="translate(0 -332)"/></g></g></g>`
  },
  download: {
    viewBox: "0 0 9.603 10.243",
    icon: `<g transform="translate(2.241)"><path  d="M133.091,4.669a.319.319,0,0,0-.291-.188h-1.28V.32A.32.32,0,0,0,131.2,0h-1.28a.32.32,0,0,0-.32.32V4.481h-1.28a.32.32,0,0,0-.241.531l2.241,2.561a.319.319,0,0,0,.481,0l2.241-2.561A.319.319,0,0,0,133.091,4.669Z" transform="translate(-127.998)"/></g><g transform="translate(0 7.042)">
<path  d="M24.323,352v1.921H17.28V352H16v2.561a.64.64,0,0,0,.64.64h8.323a.64.64,0,0,0,.64-.64V352Z" transform="translate(-16 -352)"/></g`
  },
  play: {
    viewBox: "0 0 7.236 8.916",
    icon: `<g >
   <path  d="M6.855,3.77,1.169.146A.772.772,0,0,0,0,.866V8.111a.776.776,0,0,0,1.169.719L6.855,5.208a.869.869,0,0,0,0-1.438Z" 
   transform="translate(0 -0.032)"/></g>`
  },
  star: {
    viewBox: "0 0 13.639 13.054",
    icon: `<g>
<path d="M26.587.441,24.922,3.817,21.2,4.36a.816.816,0,0,0-.451,1.392l2.695,2.626L22.8,12.086a.815.815,0,0,0,1.183.859l3.332-1.751,3.332,1.751a.816.816,0,0,0,1.183-.859L31.2,8.377l2.695-2.626A.816.816,0,0,0,33.44,4.36l-3.724-.543L28.05.441A.816.816,0,0,0,26.587.441Z" 
transform="translate(-20.5 0.013)"/></g>`
  },
  searchSolid: {
    viewBox: "0 0 12.113 12.115",
    icon: `<g><path 
	 d="M11.948,10.474,9.589,8.115a.567.567,0,0,0-.4-.166H8.8A4.919,4.919,0,1,0,7.95,8.8v.386a.567.567,0,0,0,.166.4l2.359,2.359a.565.565,0,0,0,.8,0l.67-.67A.57.57,0,0,0,11.948,10.474ZM4.921,7.95A3.028,3.028,0,1,1,7.95,4.921,3.027,3.027,0,0,1,4.921,7.95Z"/></g>`
  },
  barsSolid: `<g  viewBox="0 0 11.834 12">
   <path  d="M.423,62.2H11.411a.46.46,0,0,0,.423-.49V60.49a.46.46,0,0,0-.423-.49H.423A.46.46,0,0,0,0,60.49v1.224A.46.46,0,0,0,.423,62.2Zm0,4.9H11.411a.46.46,0,0,0,.423-.49V65.388a.46.46,0,0,0-.423-.49H.423a.46.46,0,0,0-.423.49v1.224A.46.46,0,0,0,.423,67.1Zm0,4.9H11.411a.46.46,0,0,0,.423-.49V70.286a.46.46,0,0,0-.423-.49H.423a.46.46,0,0,0-.423.49V71.51A.46.46,0,0,0,.423,72Z" transform="translate(0 -60)"/></g>`,
...
`,
  ...
  left: {
    viewBox: "0 0 16 16",
    icon: `<g stroke-width="0" ><path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"></path></g>`
  },
  right: {
    viewBox: "0 0 16 16",
    icon: `<g  stroke-width="0" ><path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"></path></g>`
  },
  moon: {
    viewBox: "0 0 384 512",
    icon: `<g >
  ...
  closeCircle: {
    viewBox: "0 0 24 24",
    icon: `<g  fill="none"><path d="M12 22c5.5 0 10-4.5 10-10S17.5 2 12 2 2 6.5 2 12s4.5 10 10 10ZM9.17 14.83l5.66-5.66M14.83 14.83 9.17 9.17" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></g>`
  },
  tickCircle: {
    viewBox: "0 0 24 24",
    icon: `<g  fill="none"><path d="M12 22c5.5 0 10-4.5 10-10S17.5 2 12 2 2 6.5 2 12s4.5 10 10 10Z" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="m7.75 12 2.83 2.83 5.67-5.66" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></g>`
  },
  refreshCircle: {
    viewBox: "0 0 24 24",
    icon: `<g  fill="none"><path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"></path><path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.01 14.51c.18.3.4.58.65.83a4.732 4.732 0 006.68 0 4.71 4.71 0 001.32-2.67M7.34 11.33c.14-.98.57-1.92 1.32-2.67a4.732 4.732 0 016.68 0c.26.26.47.54.65.83"></path><path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.82 17.18v-2.67h2.67M16.18 6.82v2.67h-2.67"></path></g>`
  },
  infoCircle: {
    viewBox: "0 0 24 24",
    icon: `<g  fill="none"><path d="M12 22c5.5 0 10-4.5 10-10S17.5 2 12 2 2 6.5 2 12s4.5 10 10 10ZM12 8v5" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M11.995 16h.009" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></g>`
  }
};
exports.BEYOND_ICONS = BEYOND_ICONS;
}});

__pkg.exports.descriptor = [{"im":"./beyond-icon-button","from":"BeyondIconButton","name":"BeyondIconButton"},{"im":"./icon","from":"BeyondIcon","name":"BeyondIcon"},{"im":"./icons","from":"BEYOND_ICONS","name":"BEYOND_ICONS"}];

export let BeyondIconButton, BeyondIcon, BEYOND_ICONS;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'BeyondIconButton') && (BeyondIconButton = require ? require('./beyond-icon-button').BeyondIconButton : value);
    (require || prop === 'BeyondIcon') && (BeyondIcon = require ? require('./icon').BeyondIcon : value);
    (require || prop === 'BEYOND_ICONS') && (BEYOND_ICONS = require ? require('./icons').BEYOND_ICONS : value);
...
//# sourceMappingURL=icons.browser.mjs.map