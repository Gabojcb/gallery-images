System.register(["@beyond-js/widgets/render", "@beyond-js/kernel/bundle", "@beyond-js/react-widgets/page", "react", "@bgroup/ui/header", "@bgroup/ui/spinner", "@bgroup/ui/copyable-implementation", "@bgroup/ui/implementation-result", "@beyond-js/kernel/styles"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgetsRender) {
    ...
    }, function (_bgroupUiSpinner) {
      dependency_5 = _bgroupUiSpinner;
      ...
      dependency_7 = _bgroupUiImplementationResult;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@bgroup/ui@0.0.34/beyond-spinner"
        },
        "type": "widget"
      }, _context.meta.url).package();
      ;
      __pkg.dependencies.update([['@beyond-js/widgets/render', dependency_0], ['@beyond-js/react-widgets/page', dependency_2], ['react', dependency_3], ['@bgroup/ui/header', dependency_4], ['@bgroup/ui/spinner', dependency_5], ['@bgroup/ui/copyable-implementation', dependency_6], ['@bgroup/ui/implementation-result', dependency_7], ['@beyond-js/kernel/styles', dependency_8]]);
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@bgroup/ui@0.0.34/beyond-spinner');
      ims = new Map();
      /****************************
      ...
      ims.set('./views/index', {
        ...
        creator: function (require, exports) {
          ...
          function View() {
            ...
            }, React.createElement("h3", null, "Import:"), React.createElement(_copyableImplementation.CopyableImplementation, null, `import { BeyondSpinner } from '@bgroup/ui/spinner';`)), React.createElement("div", {
...
//# sourceMappingURL=beyond-spinner.sjs.js.map