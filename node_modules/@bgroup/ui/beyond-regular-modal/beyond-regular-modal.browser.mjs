...
import * as dependency_6 from '@bgroup/ui/modal';

const {Bundle: __Bundle} = dependency_1;
const __pkg = new __Bundle({"module":{"vspecifier":"@bgroup/ui@0.0.34/beyond-regular-modal"},"type":"widget"}, import.meta.url).package();;

__pkg.dependencies.update([['@beyond-js/widgets/render', dependency_0],['@beyond-js/react-widgets/page', dependency_2],['react', dependency_3],['@bgroup/ui/header', dependency_4],['@bgroup/ui/copyable-implementation', dependency_5],['@bgroup/ui/modal', dependency_6]]);

brequire('@beyond-js/widgets/render').widgets.register([{"name":"beyond-regular-modal","vspecifier":"@bgroup/ui@0.0.34/beyond-regular-modal","is":"page","route":"/components/beyond-regular-modal"}]);
...
ims.set('./views/implementation', {hash: 122166778, creator: function (require, exports) {
"use strict";
...
ims.set('./views/index', {hash: 3431307835, creator: function (require, exports) {
"use strict";
...
/*bundle*/function View() {
  ...
  }, React.createElement("h3", null, "Import:"), React.createElement(_copyableImplementation.CopyableImplementation, null, `import { BeyondModal } from '@bgroup/ui/modal';`)), React.createElement("div", {
...
ims.set('./views/results', {hash: 2006307511, creator: function (require, exports) {
"use strict";
...
//# sourceMappingURL=beyond-regular-modal.browser.mjs.map