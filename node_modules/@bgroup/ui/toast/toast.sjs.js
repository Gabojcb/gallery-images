System.register(["@beyond-js/kernel/bundle", "@beyond-js/kernel/styles", "react", "@bgroup/ui/hooks", "@bgroup/ui/reactive-model", "@bgroup/ui/icons"], function (_export, _context) {
  "use strict";

  var dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, __Bundle, __pkg, ims, Toasts, ToastTypes, IToast, toast, Toast, __beyond_pkg, hmr;
  _export({
    Toasts: void 0,
    ToastTypes: void 0,
    IToast: void 0,
  ...
  return {
    setters: [function (_beyondJsKernelBundle) {
      ...
      dependency_3 = _bgroupUiHooks;
    }, function (_bgroupUiReactiveModel) {
      dependency_4 = _bgroupUiReactiveModel;
    }, function (_bgroupUiIcons) {
      dependency_5 = _bgroupUiIcons;
    }],
    execute: function () {
      ({
        Bundle: __Bundle
...
//# sourceMappingURL=toast.sjs.js.map