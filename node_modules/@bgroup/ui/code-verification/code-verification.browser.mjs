...
const __pkg = new __Bundle({"module":{"vspecifier":"@bgroup/ui@0.0.34/code-verification"},"type":"code","name":"code-verification"}, import.meta.url).package();;
...
ims.set('./code-input', {hash: 4210698978, creator: function (require, exports) {
"use strict";
...
ims.set('./input', {hash: 340004181, creator: function (require, exports) {
"use strict";
